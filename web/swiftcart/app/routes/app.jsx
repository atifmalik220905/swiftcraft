...
const NAV_ITEMS = [
  ...
  { href: "/app/volume-discounts", icon: "grid_view", label: "Volume Discounts" },
...
function BottomNavItem({ href, icon, label, isActive }) {
  return (
    <Link
      to={href}
      className={`flex flex-col items-center justify-center active:scale-90 duration-200 ${isActive
