...
export const action = async ({ request }) => {
  ...
  switch (intent) {
    case "create": {
      ...
      result = { success: true, message: "Rule created!" };
      break;
    }

    case "update": {
      const ruleId = formData.get("ruleId");
      await updateUpsellRule(ruleId, {
      ...
      result = { success: true, message: "Rule updated!" };
      break;
    }

    case "toggle": {
      const ruleId = formData.get("ruleId");
      await toggleUpsellRule(ruleId);
      result = { success: true };
      break;
    }
    ...
    case "delete": {
      const ruleId = formData.get("ruleId");
      await deleteUpsellRule(ruleId);
      result = { success: true, message: "Rule deleted" };
      break;
    }
  }
